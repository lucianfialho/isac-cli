export const ANIMATION_DETECTION_SCRIPT = `(function detectAnimations() {
  ...
  function detectLibraries() {
    ...
    if (window.Lenis || window.LocomotiveScroll) libraries.push({ name: 'smooth-scroll', version: 'detected' });
  ...
  function generateCatalog() {
    ...
    const allAnimations = [...cssAnimations, ...cssTransitions, ...webAnimations, ...scrollAnimations];
